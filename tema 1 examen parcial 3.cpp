/*tema1: Realizar un programa en c++ que nos permita que el usuario carga los elementos a nuestra matriz donde nuestra fila va se N y nuestra 
columna va ser N ya que el usuario eligira el cuantos elementos habra dentro de la matriz y luego debemos usar un contador para ver cuantas 
veces se repite el mayor numero dentro de la matriz  y luego en el acumulador la suma de los numeros mayores repetidos, calcular el promedio 
del total de los elementos dentro de la matriz y por ultimo luego dentro de un vector llamado menor cargaremos los elementos de las columnas
y sacar el menor */
#include<iostream>
#include<conio.h>
using namespace std;
