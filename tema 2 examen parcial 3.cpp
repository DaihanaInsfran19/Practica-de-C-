/*tema2: en este problema se desea realizar un programa en c++ donde se creara una matriz de N y M elementos donde se desea que el 
usuario eliga cuantos elementos existira en este, tambien se desea que logremos utiliza dos vectores de 
nombre vec1 y el otro de nombre vec2 y con cada una de los vectores debemos realizar una 
operacion aritmetica con vec1 se realizara una suma total vec1 y luego vec2 y con el vec2 se realizara 
una resta con con los elementos de la vec1 o si queremos con los elementos de vec1 y por ultimo hallar el mayor elemento que se encuetra
